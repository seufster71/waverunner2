    ...
    <div>
      ...
      <div>
        ...
        <input
          ...
          value={
            itemState.item != null && itemState.item.BuyAmount != null
              ? itemState.item.BuyAmount
              : buyAmount
          }
        />
      </div>
      <div>
        ...
        <input
          ...
          className="form-control"
          autoCapitalize="off"
          onChange={inputChange.bind(event, "TEXT", "SellAmount", "")}
          value={
            itemState.item != null && itemState.item.SellAmount != null
              ? itemState.item.SellAmount
              : sellAmount
          }
        />
      </div>
      <div>
        ...
        <input
          ...
          className="form-control"
          autoCapitalize="off"
          onChange={inputChange.bind(event, "TEXT", "Algorithum", "")}
          value={
            itemState.item != null && itemState.item.Algorithum != null
              ? itemState.item.Algorithum
              : algorithum
          }
        />
      </div>
      <div>
        <input
          ...
          className="form-control"
          value={saveTxt}
          onClick={onOption.bind(event, "SAVE")}
        />
      </div>
    </div>
  );
